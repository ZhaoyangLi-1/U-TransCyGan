...
# from modules import TranspConv3DBlock, BlueBlock, Conv3DBlock
from models.volume_embedding import Embeddings3D
from models.transformer_vanilla import TransformerBlock


class TransformerEncoder(nn.Module):
    def __init__(self, embed_dim, num_heads, num_layers, dropout, dim_linear_block):
        super().__init__()
        ...
        for _ in range(num_layers):
            self.block_list.append(TransformerBlock(dim=embed_dim, blocks=num_layers, heads=num_heads, 
                                    dim_head=None, dim_linear_block=dim_linear_block, dropout=dropout, prenorm=False))
